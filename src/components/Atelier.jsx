...
export default function Atelier({ lang }) {
  ...
  const slatBodyH = Math.max(2.5, visSpacing * 0.86 * Math.abs(cos))
    ...
    <section className="section atelier-section" id="atelier">
      <div className="shell">
        <div className="section-head">
          ...
          <h2>
            <WordsPullUp text={t.titleA} />
            {' '}<em><WordsPullUp text={t.titleB} delay={200} /></em>
          </h2>
        ...
        <div
          ...
          role="img"
          aria-label={`${mat.name[lang] || mat.name.es}, ${width.mm}mm, ${Math.round(tilt)}°`}
        >
          ...
          <div className="atelier-slats" aria-hidden="true">
            {Array.from({ length: N }).map((_, i) => (
              <div
                key={i}
                className="slat-slot"
                style={{ top: `${i * visSpacing}px`, height: `${visSpacing}px` }}
              >
                <div
                  className="slat-body"
                  style={{
          ...
          <div className="atelier-headrail-a" style={{ background: mat.grad }} aria-hidden="true" />
          ...
          <div className="stage-readout" aria-hidden="true">
            ...
            <span className="sr-line num">
              {Math.round(tilt)}° · {openness}%{' '}
              {openness < 8 ? t.closed : openness > 75 ? t.open : ''}
            </span>
          </div>
        </div>
            ...
            <div className="ctrl-body">
              <div className="tilt-wrap">
                <input
                  ...
                  aria-label={t.lTilt}
                  aria-valuetext={`${Math.round(tilt)}°`}
